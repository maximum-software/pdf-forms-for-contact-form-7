		...
		public function render_tag_generator( $contact_form, $args = '' )
		{
			...
			if( class_exists('WPCF7_TagGenerator') )
				echo self::render( 'add_pdf', array(
					...
					'messages' => $messages,
					'instructions' => esc_html__( "You can use this tag generator to attach a PDF file to your form, insert tags into your form and link them to fields in the PDF file.  You can also embed images (generated by other CF7 tags or fields) into the PDF file.  Changes here are applied when the contact form is saved.", 'wpcf7-pdf-forms' ),
					...
					'field-mapping' => esc_html__( 'Input Field Mapper Tool', 'wpcf7-pdf-forms' ),
					'field-mapping-help' => esc_html__( 'Field mapper can be used to link contact form 7 fields with fields within the PDF files.  When the user submits the form, data from CF7 fields will be inserted into correspoinding fields in the PDF file.', 'wpcf7-pdf-forms' ),
					...
					'tag-generator-help' => esc_html__( 'The tag generator tool allows one to create CF7 fields that are linked to PDF fields by name.  This feature is deprecated in favor of the field mapper tool.', 'wpcf7-pdf-forms' ),
					'image-embedding' => esc_html__( 'Image Embedding Tool', 'wpcf7-pdf-forms' ),
					'image-embedding-help'=> esc_html__( 'Image embedding tool allows embedding images into PDF files.  Images are taken from field attachments or field values that are URLs.  You must select a PDF file, its page and draw a bounding box for image insertion.', 'wpcf7-pdf-forms' ),
